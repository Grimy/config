...
user_pref("extensions.dorandoKeyConfig.main.a", "][A][][BrowserOpenTab(); loadURI('about:addons')");
user_pref("extensions.dorandoKeyConfig.main.b", "][B][][BrowserOpenTab(); loadURI('chrome://browser/content/bookmarks/bookmarksPanel.xul')");
user_pref("extensions.dorandoKeyConfig.main.c", "][C][][BrowserOpenTab(); loadURI('chrome://keyconfig/content')");
...
user_pref("extensions.dorandoKeyConfig.main.p", "][P][][BrowserOpenTab(); gURLBar.value = readFromClipboard(); gURLBar.handleCommand()");
...
user_pref("extensions.dorandoKeyConfig.main.v", "][V][][BrowserOpenTab(); loadURI('about:downloads')");
...
user_pref("extensions.dorandoKeyConfig.main.key_devToolboxMenuItem", "control][:][");
